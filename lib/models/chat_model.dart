...
class ChatModel {
  ...
  /// צ'אטים לדוגמה
  static List<ChatModel> demoList(String currentUserId) {
    return [
      ChatModel(
        id: 'chat_1',
        ...
        lastMessage: MessageModel(
          ...
          content: 'כן, נשמע מעולה! נפגש מחר ב-10?',
          sentAt: DateTime.now().subtract(const Duration(minutes: 5)),
          deliveredAt: DateTime.now().subtract(const Duration(minutes: 5)),
          readAt: DateTime.now().subtract(const Duration(minutes: 4)),
        ),
        unreadCount: 0,
      ...
      ChatModel(
        ...
        lastMessage: MessageModel(
          ...
          chatId: 'chat_3',
          senderId: 'user_4',
          senderName: 'נועה שמיר',
          type: MessageType.text,
          content: 'מישהי מכירה רופא ילדים טוב באזור?',
      ...
      ChatModel(
        ...
        lastMessage: MessageModel(
          ...
          content: 'תמונה',
          mediaUrl: 'https://images.unsplash.com/photo-1519340241574-2cec6aef0c01?w=200',
